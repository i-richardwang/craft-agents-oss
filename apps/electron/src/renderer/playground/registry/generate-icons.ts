...
const TOOL_ICONS_DIR = path.join(process.env.HOME!, '.datapilot/tool-icons')
const SOURCES_DIR = path.join(
  process.env.HOME!,
  '.datapilot/workspaces/046a02d0-6521-98eb-8756-95ec4bb8c41f/sources'
)
...
// Native tool icons (from ~/.datapilot/tool-icons/)
